...
class TestMusic(TestCase):
    ...
    def setUp(self):
        ...
        self.genre = mommy.make(Genre, name='Rock')
        self.band = mommy.make(Band, name='Led Zeppelin', record=self.record, genre=self.genre)
        self.music = mommy.make(Music, name='Thank You', band=self.band, duration=datetime.now(), year=datetime.now())
...
class TestPlaylist(TestCase):
    ...
    def test_playlist_creation(self):
        ...
        self.assertEquals(self.playlist.__str__(), self.playlist.name)